...
class _ArticlesListWidgetState extends State<ArticlesListWidget> {
  ...
  Widget build(BuildContext context) {
    return widget.articlesData.isNotEmpty ? Center(
      child: SizedBox(
        height: 250,
        width: 225,
        child: Material(
                ...
                child: Padding(
                  ...
                  child: Center(
                    child: Text(widget.articlesData[widget.index][1],
                      style: GoogleFonts.ubuntuMono(fontSize: 17, color: Colors.black54),),
                  ),
                ),
            ),
            Expanded(
                      ...
                      onPressed: () async {
                        ...
                        showDialog(
                          ...
                          builder: (BuildContext context) {
                            return AlertDialog(
                              scrollable: true,
                              title: Text(widget.articlesData[widget.index][1], style: GoogleFonts.ubuntuMono(fontSize: 35, color: Colors.black87,), textAlign: TextAlign.center,),
                              content: Padding(
                                ...
                                child: Form(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(height: 20,),
                                        Text(data, style: GoogleFonts.ubuntuMono(fontSize: 21, color: Colors.black87),)
                                      ],
                                    )
                                ),
                              ),
